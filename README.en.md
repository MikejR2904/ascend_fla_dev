...
|---|---|---|---|---|
| KDA (Kimi Delta Attention) | `kda` | open to agents | 7 | 9/23 |
...
<details><summary><b>KDA (Kimi Delta Attention) —— 7 kernel(s)，9/23 done</b></summary>
...
| `kda_prep` | open to agents | ✅ native · A5 hw | ✅ native · A5 hw | 2/3 | [#106](https://github.com/ddddwee1/ascend_fla_dev/issues/106) BF-07 |
...
<details><summary>kda_prep —— 2/3 done，start BF-07</summary>

...
|---|---|---|---|
| `kda_fwd_stable` | open to agents | 3/10 | [#34](https://github.com/ddddwee1/ascend_fla_dev/issues/34) A2-03 |
...
| task | issue | SoC | dtype | status | note |
|---|---|---|---|---|---|
| PK-02 | [#68](https://github.com/ddddwee1/ascend_fla_dev/issues/68) | `a5` | bf16、fp32 | 🔵 in_progress | ★ start |
...
| task | issue | SoC | dtype | status | note |
|---|---|---|---|---|---|
| PK-03 | [#69](https://github.com/ddddwee1/ascend_fla_dev/issues/69) | `a5` | bf16、fp32 | 🔵 in_progress | ★ start |

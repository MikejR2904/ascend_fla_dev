...
|---|---|---|---|---|
| KDA (Kimi Delta Attention) | `kda` | open to agents | 7 | 6/21 |
...
<details><summary><b>KDA (Kimi Delta Attention) —— 7 kernel(s)，6/21 done</b></summary>
...
|---|---|---|---|
| `bf16` | open to agents | 43 | Current ABI: q/k/v/o and most intermediates |

...
| GD2-04 | [#72](https://github.com/ddddwee1/ascend_fla_dev/issues/72) | `a5` | bf16、fp32 | 🔒 gated (user-decision) |  |
...
| dtype | 归属 | 涉及任务 | 说明 |
|---|---|---|---|
| `bf16` | 可申领 | 23 | 当前 ABI：q/k/v/o 与多数中间量 |
| `fp32` | 可申领 | 30 | 当前 ABI：state、门控累加、精度判定一律 fp32 |

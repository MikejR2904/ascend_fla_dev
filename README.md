...
|---|---|---|---|---|
| KDA（Kimi Delta Attention） | `kda` | 可申领 | 7 | 8/22 |
...
<details><summary><b>KDA（Kimi Delta Attention） —— 7 个 kernel，8/22 完成</b></summary>
...
| `kda_prep` | 可申领 | ✅ 原生 · A5 真机 | ✅ 原生 · A5 真机 | 1/2 | [#106](https://github.com/ddddwee1/ascend_fla_dev/issues/106) BF-07 |
...
<details><summary>kda_prep —— 1/2 完成，起点 BF-07</summary>
...
| 任务 | issue | SoC | dtype | 状态 | 说明 |
|---|---|---|---|---|---|
| A2-07 | [#35](https://github.com/ddddwee1/ascend_fla_dev/issues/35) | `a2` | bf16、fp32 | 🔵 assigned | ★ 起点 |

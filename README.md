...
| GDN（Gated DeltaNet） | `gated_delta_rule` | 可申领 | 4 | 2/5 |
...
<details><summary><b>GDN（Gated DeltaNet） —— 4 个 kernel，2/5 完成</b></summary>
...
| kernel | 归属 | 进度 | 下一步 |
|---|---|---|---|
| `gdn_fwd` | 可申领 | 2/5 | [#35](https://github.com/ddddwee1/ascend_fla_dev/issues/35) A2-07 |
...
<details><summary>gdn_fwd —— 2/5 完成，起点 A2-07、GDA-01</summary>
...
<details><summary><b>PKDA / PGDN（预条件） —— 2 个 kernel，2/2 完成</b></summary>
...
| kernel | 归属 | 进度 | 下一步 |
|---|---|---|---|
| `pkda_chunk_fwd` | 可申领 | 1/1 | [#68](https://github.com/ddddwee1/ascend_fla_dev/issues/68) PK-02 |
| `pgdn_chunk_fwd` | 可申领 | 1/1 | [#69](https://github.com/ddddwee1/ascend_fla_dev/issues/69) PK-03 |

<details><summary>pkda_chunk_fwd —— 1/1 完成，起点 PK-02</summary>
...
<details><summary>pgdn_chunk_fwd —— 1/1 完成，起点 PK-03</summary>
...
| dtype | 归属 | 涉及任务 | 说明 |
|---|---|---|---|
| `bf16` | 可申领 | 28 | 当前 ABI：q/k/v/o 与多数中间量 |
| `fp32` | 可申领 | 35 | 当前 ABI：state、门控累加、精度判定一律 fp32 |

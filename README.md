...
| GDN-2（Gated DeltaNet 2） | `gdn2` | 仓主轨道 | 6 | 2/3 |
...
<details><summary><b>GDN-2（Gated DeltaNet 2） —— 6 个 kernel，2/3 完成</b></summary>
...
| `gdn2_chunk_fwd` | 可申领 | 2/3 | [#62](https://github.com/ddddwee1/ascend_fla_dev/issues/62) GD2-01 |
| `gdn2_chunk_fwd_bwd` | 仓主轨道 | — | _反向仍未排期；前向已由 agent 轨道完成，见 gdn2_chunk_fwd_ |

<details><summary>gdn2_chunk_fwd —— 2/3 完成，起点 GD2-01</summary>

...
| A5K-02 | [#81](https://github.com/ddddwee1/ascend_fla_dev/issues/81) | `a5` | bf16、fp32 | 🔵 in_progress |  |
...
| 任务 | issue | SoC | dtype | 状态 | 说明 |
|---|---|---|---|---|---|
| PK-03 | [#69](https://github.com/ddddwee1/ascend_fla_dev/issues/69) | `a5` | bf16、fp32 | 🔵 in_progress | ★ 起点 |

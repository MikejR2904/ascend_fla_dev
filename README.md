...
| GDN-2（Gated DeltaNet 2） | `gdn2` | 仓主轨道 | 6 | 2/4 |
...
| GDA-01 | [#73](https://github.com/ddddwee1/ascend_fla_dev/issues/73) | `a5` | bf16、fp32 | ⬜ open | ★ 起点 |
| A2-K1 | [#44](https://github.com/ddddwee1/ascend_fla_dev/issues/44) | `a2` | bf16、fp32 | 🔒 gated (kernel-batch-approval) |  |
...
<details><summary><b>GDN-2（Gated DeltaNet 2） —— 6 个 kernel，2/4 完成</b></summary>
...
| `gdn2_chunk_fwd` | 可申领 | 2/4 | [#62](https://github.com/ddddwee1/ascend_fla_dev/issues/62) GD2-01 |
| `gdn2_chunk_fwd_bwd` | 仓主轨道 | — | _反向仍未排期；前向已由 agent 轨道完成，见 gdn2_chunk_fwd_ |

<details><summary>gdn2_chunk_fwd —— 2/4 完成，起点 GD2-01</summary>
...
| GD2-04 | [#72](https://github.com/ddddwee1/ascend_fla_dev/issues/72) | `a5` | bf16、fp32 | 🔵 assigned |  |
...
| dtype | 归属 | 涉及任务 | 说明 |
|---|---|---|---|
| `bf16` | 可申领 | 24 | 当前 ABI：q/k/v/o 与多数中间量 |
| `fp32` | 可申领 | 31 | 当前 ABI：state、门控累加、精度判定一律 fp32 |

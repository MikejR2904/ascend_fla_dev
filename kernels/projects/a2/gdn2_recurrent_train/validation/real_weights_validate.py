...
CKPT = sys.argv[1] if len(sys.argv) > 1 else glob.glob("/workspace/gdn2_ckpts/gdn2-370m-5b/*.pth")[0]
PRESET = sys.argv[2] if len(sys.argv) > 2 else "370m"
DEV = "npu:0"

# --- deployed training op (compiles both a2 kernels) ---
_spec = importlib.util.spec_from_file_location(
    "gdn2_ag", "/workspace/ascend_fla_dev/kernels/projects/a2/gdn2_recurrent_train/autograd.py")

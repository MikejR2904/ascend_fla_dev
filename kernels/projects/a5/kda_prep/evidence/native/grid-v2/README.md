# Complete ordinary public-grid receipts retrieved so far

Chunk bd1/2/3/4: 1620 cases each, all pass. Decode bd1/2/4: 3240 cases each,
...
These seven runs contain 32,421 original JSON receipts, including case results,
...
`restore-verification.json` records a fresh restoration and exact comparison of

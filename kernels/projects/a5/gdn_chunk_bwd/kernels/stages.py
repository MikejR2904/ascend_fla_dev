"""FP32 recurrent checkpoint/replay adjoint; no state inversion or atomics.
...
@kernel()
def gdn_bwd_checkpoints(
    k: GM[f32, ("B", "T", "H", 128)], v: GM[f32, ("B", "T", "HV", 128)],
...
def gdn_bwd_reverse(
    ...
    v: GM[f32, ("B","T","HV",128)], g: GM[f32, ("B","T","HV")],
    beta: GM[f32, ("B","T","HV")], dout: GM[f32, ("B","T","HV",128)],
    dht: GM[f32, ("B","HV",128,128)],
    checkpoints: GM[f32, ("B","N","HV",128,128)],
    tape: GM[f32, ("B","HV",64,128,128)],
    dq_parts: GM[f32, ("B","T","HV",128)], dk_parts: GM[f32, ("B","T","HV",128)],
    dv: GM[f32, ("B","T","HV",128)], dg: GM[f32, ("B","T","HV")],
    dbeta: GM[f32, ("B","T","HV")],
    B: i32, T: i32, H: i32, HV: i32, N: i32,
):
    state = Tensor(DT.float,[D,D],Position.UB)
    ...
    gu = Tensor(DT.float,[1,8],Position.UB)
    bu = Tensor(DT.float,[1,8],Position.UB)
    ou = Tensor(DT.float,[1,D],Position.UB)

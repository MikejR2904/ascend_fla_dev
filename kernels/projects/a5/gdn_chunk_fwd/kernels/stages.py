"""Five-launch FP32 Vector baseline for the scalar-gated GDN chunk equations.

The generic causal-score/WY/scan/output mechanics are adapted from this
repository's GDN-2 chunk unit at 8786683. Scalar beta/g and unnormalized q/k
are GDN-specific. This module has no GDN-2 runtime dependency.
...
STAGES = (gdn_chunk_prepare, gdn_chunk_scores, gdn_chunk_wy,
          gdn_chunk_scan, gdn_chunk_output)
